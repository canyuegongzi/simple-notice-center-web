...
import {baseURL, bspURL, domain, ENV, fileBaseURL, permissionBaseURL, userBaseURL} from "../config";
...
axios.interceptors.request.use((config: any) => {
    ...
    const sessionStorageToken: any = mimeStorage.getItem('token') || sessionStorage.getItem('token');
